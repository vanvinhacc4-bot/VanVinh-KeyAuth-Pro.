...
// ==========================================
// FIX LỖI LINKER - ÉP BIẾN RA NGOÀI (EXTERNAL)
// ==========================================
extern "C" {
    ...
    // ĐÂY LÀ 2 DÒNG QUAN TRỌNG ĐỂ FIX LỖI TRONG ẢNH CỦA MÀY
    ...
    __attribute__((visibility("default"))) const uint8_t KEYAUTH_ENC_APP_ID[] = {0x46, 0x6a, 0x46, 0x6c, 0x6c, 0x78, 0x63, 0x53, 0x6a, 0x32}; 
